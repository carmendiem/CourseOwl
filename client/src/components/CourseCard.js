...
export function CourseCard({ user, course, onChange }) {
    ...
    Expected Weekly Time Commitment: {course.credit_hours > 0 ? `${course.credit_hours * 3} hours` : "N/A"}
            ...
            <Dialog open={openCourseFullDialog} onClose={handleCloseCourseFullDialog}>
                ...
                <DialogContent>
                    <Typography>This course is currently full. Would you like to receive an alert when it becomes available?</Typography>
                </DialogContent>
                <DialogActions>
            ...
            <Dialog open={openCourseOptInDialog} onClose={handleCourseOptInDialog}>
                ...
                <DialogContent>
                    <Typography>You have opted in to receive alerts when this course becomes available.</Typography>
                </DialogContent>
                <DialogActions>
